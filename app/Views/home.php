...
<section id="spotlight-outer">
    <div id="spotlight-inner">
        ...
        <div id="spotlight-note" class="animated fadeInDown">小巧而功能强大</div>
            ...
            <a href="https://github.com/codeigniter4/CodeIgniter4" class="github-link" target="_blank">
                <div class="githubs">
                    <div class="github-icon">
                        <svg height="32" viewBox="0 0 32 32" width="32" xml:space="preserve"
                             xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd"
                                                                      ...
                                                                      fill="#181616" fill-rule="evenodd"/></svg>
                        <div class="github-data">
                            <span class="boldy700">Star</span> <span id="stargazers_count">4030</span>
                        </div>
                    </div>
                </div>
            </a>
...
<section class="content-outer">
    <div class="content-inner">
        ...
        <div class="section-title">为什么选择 CodeIgniter?</div>
        <div class="clr"></div>
        ...
        <div class="why-rows">
            <div class="ci-features-box">
                <div class="ci-features-box-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="51" height="59" viewBox="0 0 51 59"
                         xml:space="preserve"><path fill="none" stroke="#F15C28" stroke-miterlimit="10"
                                                    d="m48.445 23.053-15.18-1.33-.021-.006s-4.707-10.592-6.16-14.124c-1.455-3.531-3.116 0-3.116 0l-6.013 14.064-15.27 1.326s-3.871.497-.957 2.965C4.636 28.412 13.24 36.12 13.274 36.15l-.038-.028s-2.521 11.313-3.453 15.019c-.933 3.701 2.503 1.854 2.503 1.854l13.19-7.807.284-.023c.11.063 10.059 5.79 13.297 7.773 3.256 1.996 2.517-1.836 2.517-1.836l-3.513-14.908c1.008-.914 8.66-7.859 11.363-10.183 2.896-2.489-.979-2.958-.979-2.958zM13.276 36.15l.031.023m24.631.08.004.017"/>
                        <path opacity=".5" fill="#F4E7E4"
                              d="M29.309 16.157c.306-.378.584-.741.842-1.095-1.244-2.838-2.557-5.852-3.209-7.439-1.455-3.531-3.116 0-3.116 0l-6.013 14.064-15.27 1.326s-3.871.497-.958 2.965c2.909 2.463 11.512 10.17 11.546 10.202l-.039-.027S10.571 47.466 9.639 51.17c-.933 3.703 2.503 1.854 2.503 1.854l2.076-1.229c2.349-9.326 7.383-26.101 15.091-35.638z"/></svg>
            ...
            <div class="ci-features-box">
                <div class="ci-features-box-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="51" height="59" viewBox="0 0 51 59"
                         xml:space="preserve"><path fill="#C9340A"
                                                    d="M26.303 13.447a.668.668 0 0 1-1.336 0v-2.272a.669.669 0 0 1 1.336 0v2.272zM10.1 29.573c.368 0 .667.298.667.666a.67.67 0 0 1-.667.669H7.827a.667.667 0 1 1 0-1.335H10.1zM40.901 30.239a.666.666 0 1 1 0-1.333h2.271a.668.668 0 1 1 0 1.333h-2.271zM37.839 19.838a.665.665 0 0 1-.942-.019.664.664 0 0 1 .02-.945l1.639-1.573a.665.665 0 0 1 .942.019.665.665 0 0 1-.018.943l-1.641 1.575zM14.525 18.075a.667.667 0 1 1-.963.924l-1.574-1.64a.667.667 0 1 1 .965-.924l1.572 1.64zM29.062 29.275c-.776.467-1.574.567-1.78.222-.209-.344.252-1.003 1.028-1.471l4.783-2.884c.776-.468 1.575-.567 1.783-.223.21.346-.252 1.004-1.028 1.472l-4.786 2.884z"/>
                        <circle fill="#C9340A" cx="25.75" cy="30.24" r="3.031"/>
                        <path fill="#C9340A"
                              d="M34.102 40.217a.887.887 0 0 1-.888.888H18a.89.89 0 1 1 0-1.777h15.214c.491 0 .888.398.888.889z"/>
                        <circle fill="none" stroke="#F15C28" stroke-miterlimit="10" cx="25.501" cy="29.427" r="22.833"/>
                        <circle fill="none" stroke="#F15C28" stroke-miterlimit="10" cx="25.501" cy="29.426" r="18.341"/></svg>
                </div><!--ci-features-box-icon ends here-->
                <div class="ci-features-box-text-area">
                    <div class="ci-features-box-title">出色的性能</div>
                    <div class="clr"></div>
                    <div class="ci-features-box-text">
        ...
        <div class="why-rows">
            <div class="ci-features-box">
                <div class="ci-features-box-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="51" height="59" viewBox="0 0 51 59"
                         xml:space="preserve"><g fill="none" stroke="#F15C28" stroke-miterlimit="10">
                            <path d="M47.226 5.013 2.005 28.5c-2.261 1.969 0 3.063 0 3.063l3.939 1.387 8.909 3.048L41.656 13.24 21.239 38.21l18.841 6.48c4.304 2.261 4.448-1.095 4.448-1.095s5.396-33.769 5.469-36.977c.073-3.209-2.771-1.605-2.771-1.605zM28.423 45.483l-6.163 6.848s-1.638 1.677-1.769-.614-.718-9.233-.718-9.233l8.65 2.999"/>
                        </g></svg>
                </div><!--ci-features-box-icon ends here-->
                <div class="ci-features-box-text-area">
                    <div class="ci-features-box-title">不喜欢复杂，热爱简单</div>
                    <div class="clr"></div>
                    <div class="ci-features-box-text">
            ...
            <div class="ci-features-box">
                <div class="ci-features-box-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="51" height="59" viewBox="0 0 51 59"
                         xml:space="preserve"><path fill="none" stroke="#F15C28" stroke-miterlimit="10"
                                                    d="M49.691 13.907c0-3.191-4.055-4.724-4.055-4.724-8.234-.479-13.945-4.085-16.66-6.447C26.266.375 25.5.981 25.5.981s-.767-.606-3.479 1.755c-2.713 2.362-8.425 5.969-16.66 6.447 0 0-4.054 1.532-4.054 4.724s-3.256 26.906 11.426 37.757c0 0 6.171 5.021 12.767 6.425 6.596-1.403 12.768-6.425 12.768-6.425 14.679-10.851 11.423-34.565 11.423-37.757z"/>
                        <path fill="#C9340A"
                              d="M32.074 24.864c-.637-.625-1.912-.313-3.104.855l-5.778 5.888-1.943-1.907c-.615-.603-1.622-.576-2.247.061s-.634 1.643-.018 2.249l3.401 3.336c.615.604 1.621.576 2.246-.063.282-.286 6.648-7.298 6.648-7.298 1.192-1.343 1.433-2.496.795-3.121z"/></svg>
                </div><!--ci-features-box-icon ends here-->
                <div class="ci-features-box-text-area">
        ...
        <div class="why-rows">
            <div class="ci-features-box">
                <div class="ci-features-box-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="51" height="59" viewBox="0 0 51 59"
                         xml:space="preserve"><path fill="none" stroke="#C9340A" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-miterlimit="10"
                                                    d="M25.5 15.164S4.592 11.821.673 13.781v31.89s12.874-7.103 24.827-1.914c11.952-5.188 24.827 1.914 24.827 1.914v-31.89c-3.92-1.96-24.827 1.383-24.827 1.383z"/>
                        <path fill="#FFF" stroke="#F15C28" stroke-linecap="round" stroke-linejoin="round"
                              stroke-miterlimit="10"
                              d="M25.563 15.202s-9.377-6.457-20.446-3.843v28.132s12.299-1.538 20.446 3.536c8.147-5.074 20.446-3.536 20.446-3.536V11.359c-11.067-2.614-20.446 3.843-20.446 3.843z"/>
                        <path fill="#C9340A" d="M25.5 14.5s-1.143 19.565.513 28.527"/></svg>
                </div><!--ci-features-box-icon ends here-->
                <div class="ci-features-box-text-area">
                    <div class="ci-features-box-title">清晰与完善的文档</div>
                    <div class="clr"></div>
                    <div class="ci-features-box-text">
    ...
    <div id="important-links-inner">
        ...
        <a href="/forums" class="important-link" target="_blank">
            <div class="important-link-boxes">
                ...
                加入我们的社区
                <br/><br/>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 84 84" xml:space="preserve"><path
                            d="M82 8.993H34c-1.1 0-2 .9-2 2v14H2c-1.1 0-2 .9-2 2v32c0 1.1.9 2 2 2h8v12c0 3 2.9 1.9 3.4 1.4l13.4-13.4H50c1.1 0 2-.9 2-2v-14h5.3l13.3 13.4c1.3 1.3 3.4.3 3.4-1.4v-12h8c1.1 0 2-.9 2-2v-32c0-1.1-.9-2-2-2zm-34 48H26c-.5 0-1 .2-1.4.6L14 68.193v-9.2c0-1.1-.9-2-2-2H4v-28h28v14c0 1.1.9 2 2 2h14v12zm32-16h-8c-1.1 0-2 .9-2 2v9.2l-10.5-10.6c-.4-.4-.9-.6-1.4-.6H36v-28h44v28z"/></svg>
            </div> <!--important-link-boxes ends here-->
        </a>
        ...
        <a href="https://github.com/codeigniter4/CodeIgniter4" class="important-link" target="_blank">
            <div class="important-link-boxes">
                ...
                帮助修复 BUG 或开发新功能
                <br/><br/>
                <svg height="32" viewBox="0 0 32 32" width="32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path
                            clip-rule="evenodd"
                            d="M16.003 0C7.17 0 .008 7.162.008 15.997c0 7.067 4.582 13.063 10.94 15.179.8.146 1.052-.328 1.052-.752 0-.38.008-1.442 0-2.777-4.449.967-5.371-2.107-5.371-2.107-.727-1.848-1.775-2.34-1.775-2.34-1.452-.992.109-.973.109-.973 1.605.113 2.451 1.649 2.451 1.649 1.427 2.443 3.743 1.737 4.654 1.329.146-1.034.56-1.739 1.017-2.139-3.552-.404-7.286-1.776-7.286-7.906 0-1.747.623-3.174 1.646-4.292-.165-.404-.715-2.031.157-4.234 0 0 1.343-.43 4.398 1.641a15.31 15.31 0 0 1 4.005-.538c1.359.006 2.727.183 4.005.538 3.055-2.07 4.396-1.641 4.396-1.641.872 2.203.323 3.83.159 4.234 1.023 1.118 1.644 2.545 1.644 4.292 0 6.146-3.74 7.498-7.304 7.893C19.479 23.548 20 24.508 20 26v4.428c0 .428.258.901 1.07.746C27.422 29.055 32 23.062 32 15.997 32 7.162 24.838 0 16.003 0z"
                            fill="#181616" fill-rule="evenodd"/></svg>
            </div> <!--important-link-boxes ends here-->
...
<section class="content-outer">
    <div class="content-inner">
        ...
        <div class="section-title">CodeIgniter 论坛</div>
